...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        '-mx-4 -mb-4 flex flex-col-reverse gap-2 border-t-[3px] border-ink bg-muted/50 p-4 sm:flex-row sm:justify-end',
        className,
      )}
      {...props}
    >
...
function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      ...
      className={cn(
        'font-display text-base text-ink uppercase leading-none',
        className,
      )}
      {...props}
    />
